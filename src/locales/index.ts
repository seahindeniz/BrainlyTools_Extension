      ...
      users: {
        ...
        privilegeList: {
          ...
          6: {
            ...
            description: "On the user contents page, the moderator can verify answers by selecting 25 answers max- on each page"
          },
          7: {
          ...
          98: {
            ...
            description: "User will not see any channels other than the #announcements and #rules channels on the Discord server"
          },
          40: {
