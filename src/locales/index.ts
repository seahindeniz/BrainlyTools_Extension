export default {
  ...
  core: {
    ...
    massModerateReportedContents: {
      ...
      notificationMessages: {
        cantFetchDetailsFromExtensionServer: "There is a problem with extension's server while fetching details about moderate all",
        noModeratableContentLeft: "There is no moderatable content that remains"
      },
      ...
      filter: {
        ...
        Reporter: {
          text: "Reporter user",
          title: "The user who has reported the content"
        },
        Reported: {
          text: "Reported user",
          title: "The user whose content has been reported"
        },
        DateRange: {
          text: "Reporting date",
      ...
      sections: {
        ...
        changePoints: {
          ...
          notificationMessages: {
            ...
            thereIsNoPointToGiveZeroPoints: "There is no point in giving zero points :)"
          }
        },
        changeRanks: {
          actionButton: {
  ...
  userContent: {
    notificationMessages: {
      ...
      someOfSelectedAnswersAreApproved: "Some of the selected answers have already been approved, so you technically can't approve those answers again",
      ...
      someOfSelectedAnswersAreUnapproved: "Some of the selected answers aren't approved, so you techincally can't unapprove those answers",
