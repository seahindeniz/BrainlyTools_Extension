...
export default (user) => {
	...
	<div class="sg-actions-list__hole userNoteBox">
		<div class="sg-header-secondary">
			<textarea class="sg-textarea inputNote" placeholder="${System.data.locale.texts.notes.placeholder}" title="${System.data.locale.texts.notes.description}" maxlength="1000">${user.note || ""}</textarea>
		</div>
	</div>`);
