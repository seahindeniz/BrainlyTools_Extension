...
export default class FooterQDB {
  ...
  async Delete() {
    try {
      ...
      let model_id = this.main.zdnObject.data.model_id;
      let model_type_id = this.main.zdnObject.data.model_type_id;
      let data = {
        model_id: model_id,
      ...
      System.log(
        model_type_id == 1 ? 5 : model_type_id == 2 ? 6 : 7, {
      ...
      console.error(error);
      notification({
        html: error.msg || System.data.locale.common.notificationMessages
          .somethingWentWrong,
        type: "error",
      });
    }
