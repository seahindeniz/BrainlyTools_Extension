let create_toplayer = (size = "medium", heading = "", content = "", actions = "", addAfter = "") => {
	...
	<div class="sg-toplayer${size=="medium"?" sg-toplayer--modal":""} ${size ? "sg-toplayer--" + size : ""}">
		...
		<div class="sg-toplayer__wrapper">
			<div class="sg-content-box">
				<div class="sg-content-box__content${size=="medium"?" sg-content-box__content--spaced-bottom-large":""}">${heading}</div>
