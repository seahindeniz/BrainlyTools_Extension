// @flow
import Action, { type UserType } from "@BrainlyAction";
...
import { type InputElement } from "@style-guide/Input";
...
export default class User {
  ...
  pointsInput: InputElement;
  spinnerContainer: HTMLElement;
  spinner: HTMLElement;
  currentPoints: TextElement;
  ...
  async AddPoints() {
    ...
    this.main.numberOfActiveConnections--;
    this.currentPoints.innerText = this.points + this.data.points;
