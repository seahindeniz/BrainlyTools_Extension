 ...
 * @typedef {{children?: HTMLElement, spacedTop?: Size, spacedBottom?: Size, align?: Alignment, className?: string}} Properties
 ...
 * @returns {Element}
 */
export default function({ children, spacedTop, spacedBottom, className, align = "left", ...props } = {}) {
