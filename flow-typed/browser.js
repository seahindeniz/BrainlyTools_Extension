// @flow
/* eslint-disable no-redeclare, no-undef, no-unused-vars, camelcase */
/**
...
declare interface WebExtEvent<TCallback: (...args: any[]) => any> {
...
declare var browser: typeof npm$namespace$browser; */

declare type browser$_manifest$Permission =
  | string
  | browser$_manifest$OptionalPermission
  | browser$_manifest$_Permission;

declare type browser$_manifest$OptionalPermission = browser$_manifest$_OptionalPermission;
...
declare interface browser$_manifest$WebExtensionManifest {
  experiment_apis?: {
    [key: string]: browser$experiments$ExperimentAPI,
    ...
  };
   ...
   */
  protocol_handlers?: browser$_manifest$ProtocolHandler[];
  default_locale?: string;
  minimum_chrome_version?: string;
  minimum_opera_version?: string;
  icons?: {
    [key: number]: browser$_manifest$ExtensionFileUrl,
    ...
  };
  incognito?: browser$_manifest$_WebExtensionManifestIncognito;
  background?:
    | {
        page: browser$_manifest$ExtensionURL,
        persistent?: browser$_manifest$PersistentBackgroundProperty,
        ...
      }
    | {
        scripts: browser$_manifest$ExtensionURL[],
        persistent?: browser$_manifest$PersistentBackgroundProperty,
        ...
      };
  options_ui?: {
  ...
  content_scripts?: browser$_manifest$ContentScript[];
  content_security_policy?: string;
  permissions?: browser$_manifest$PermissionOrOrigin[];
  optional_permissions?: browser$_manifest$OptionalPermissionOrOrigin[];
  ...
  user_scripts?: {
    api_script?: browser$_manifest$ExtensionURL,
    ...
  };
  browser_action?: {
    default_title?: string,
    default_icon?: browser$_manifest$IconPath,

    /**
     * Specifies icons to use for dark and light themes
     */
    theme_icons?: browser$_manifest$ThemeIcons[],
     ...
     */
    default_area?: browser$_manifest$_WebExtensionManifestBrowserActionDefaultArea,
    ...
  };
  chrome_settings_overrides?: {
    ...
    search_provider?: {
      ...
      params?: Array<{
         ...
         */
        condition?: browser$_manifest$_WebExtensionManifestChromeSettingsOverridesSearchProviderParamsCondition,
         ...
         */
        purpose?: browser$_manifest$_WebExtensionManifestChromeSettingsOverridesSearchProviderParamsPurpose,
  ...
  commands?: {
    [key: string]: {
      suggested_key?: {
        default?: browser$_manifest$KeyName,
        mac?: browser$_manifest$KeyName,
        linux?: browser$_manifest$KeyName,
        windows?: browser$_manifest$KeyName,
        chromeos?: string,
        android?: string,
        ios?: string,
  ...
  devtools_page?: browser$_manifest$ExtensionURL;
  omnibox?: {
    keyword: string,
    ...
  };
  page_action?: {
    ...
    default_popup?: string,
    browser_style?: boolean,
    show_matches?: browser$_manifest$MatchPattern[],
    hide_matches?: browser$_manifest$MatchPatternRestricted[],
    pinned?: boolean,
    ...
  };
  sidebar_action?: {
  ...
  chrome_url_overrides?: {
    newtab?: browser$_manifest$ExtensionURL,

    /**
     * @deprecated Unsupported on Firefox at this time.
     */
    bookmarks?: browser$_manifest$ExtensionURL,
  ...
  applications?: {
    gecko?: browser$_manifest$FirefoxSpecificProperties,
    ...
  };
...
declare interface browser$_manifest$ProtocolHandler {
   ...
   */
  protocol: string | browser$_manifest$_ProtocolHandlerProtocol;
   ...
   */
  uriTemplate: browser$_manifest$ExtensionURL | browser$_manifest$HttpURL;
}
...
declare interface browser$_manifest$WebExtensionLangpackManifest {
    ...
    [key: string]: {
      chrome_resources: {
        [key: string]:
          ...
          | {
              [key: string]: browser$_manifest$ExtensionURL,
              ...
            },
        ...
      },
  ...
  sources?: {
    [key: string]: {
      base_path: browser$_manifest$ExtensionURL,
      paths?: string[],
      ...
    },
    ...
...
declare interface browser$_manifest$ThemeIcons {
   ...
   */
  light: browser$_manifest$ExtensionURL;

  /**
   * The dark icon to use for light themes
   */
  dark: browser$_manifest$ExtensionURL;
...
declare type browser$_manifest$OptionalPermissionOrOrigin =
  | browser$_manifest$OptionalPermission
  | browser$_manifest$MatchPattern;
...
declare type browser$_manifest$ExtensionFileUrl = string;
...
declare type browser$_manifest$MatchPattern =
  | browser$_manifest$MatchPatternRestricted
  | browser$_manifest$MatchPatternUnestricted
  | browser$_manifest$_MatchPattern;
...
declare type browser$_manifest$IconPath =
  ...
  | browser$_manifest$ExtensionFileUrl;

declare type browser$_manifest$IconImageData =
  | {
      [key: number]: browser$_manifest$ImageData,
      ...
    }
  | browser$_manifest$ImageData;
...
declare interface browser$_manifest$ThemeType {
  ...
  colors?: {
    ...
    toolbar_field_highlight?: browser$_manifest$ThemeColor,
    toolbar_field_highlight_text?: browser$_manifest$ThemeColor,
    ...
  };
  properties?: {
    additional_backgrounds_alignment?: browser$_manifest$_ThemeTypeAdditionalBackgroundsAlignment[],
    additional_backgrounds_tiling?: browser$_manifest$_ThemeTypeAdditionalBackgroundsTiling[],
    ...
  };
}
...
declare interface browser$_manifest$ThemeManifest {
  ...
  dark_theme?: browser$_manifest$ThemeType;
  default_locale?: string;
  theme_experiment?: browser$_manifest$ThemeExperiment;
  icons?: {
    [key: number]: string,
...
declare type browser$_manifest$_WebExtensionManifestIncognito =
  | "not_allowed"
  | "spanning";
...
declare var npm$namespace$browser$activityLog: {|
  onExtensionActivity: typeof browser$activityLog$onExtensionActivity,
|};
 ...
 */
declare type browser$activityLog$_UndefinedType =
  | "api_call"
  | "api_event"
  | "content_script"
  | "user_script";
 ...
 */
declare type browser$activityLog$_UndefinedViewType =
  | "background"
  | "popup"
  | "sidebar"
  | "tab"
...
declare interface browser$activityLog$_ActivityLogOnExtensionActivityEvent<
  TCallback = (details: {
    /**
     ...
     */
    type: browser$activityLog$_UndefinedType,

    /**
     * The type of view where the activity occurred. Content scripts will not have a viewType.
     */
    viewType?: browser$activityLog$_UndefinedViewType,
 ...
 */
declare var browser$activityLog$onExtensionActivity: browser$activityLog$_ActivityLogOnExtensionActivityEvent<>;
...
declare var npm$namespace$browser$captivePortal: {|
  getState: typeof browser$captivePortal$getState,
  getLastChecked: typeof browser$captivePortal$getLastChecked,
  onStateChanged: typeof browser$captivePortal$onStateChanged,
  onConnectivityAvailable: typeof browser$captivePortal$onConnectivityAvailable,
|};

/**
 * The current captive portal state.
 */
declare type browser$captivePortal$_UndefinedState =
  | "unknown"
  | "not_captive"
  | "unlocked_portal"
  | "locked_portal";

declare type browser$captivePortal$_Status = "captive" | "clear";

/**
 * Returns the current portal state, one of `unknown`, `not_captive`, `unlocked_portal`, `locked_portal`.
 */
declare function browser$captivePortal$getState(): Promise<browser$captivePortal$_UndefinedState>;

/**
 * Returns the time difference between NOW and the last time a request was completed in milliseconds.
 */
declare function browser$captivePortal$getLastChecked(): Promise<number>;

/**
 * Fired when the captive portal state changes.
 */
declare var browser$captivePortal$onStateChanged: WebExtEvent<
  (details: {
    /**
     * The current captive portal state.
     */
    state: browser$captivePortal$_UndefinedState,
    ...
  }) => void,
>;
 ...
 */
declare var browser$captivePortal$onConnectivityAvailable: WebExtEvent<
  (status: browser$captivePortal$_Status) => void,
>;
...
declare type browser$dns$ResolveFlags = browser$dns$_ResolveFlags[];
 ...
 */
declare function browser$downloads$show(downloadId: number): Promise<boolean>;
...
declare interface browser$experiments$ExperimentAPI {
  schema: browser$experiments$ExperimentURL;
  parent?: {
    events?: browser$experiments$APIEvents,
    paths?: browser$experiments$APIPaths,
    script: browser$experiments$ExperimentURL,
    scopes?: browser$experiments$APIParentScope[],
    ...
  };
  child?: {
    paths: browser$experiments$APIPaths,
    script: browser$experiments$ExperimentURL,
    scopes: browser$experiments$APIChildScope[],
    ...
  };
}
...
declare type browser$experiments$APIPaths = browser$experiments$APIPath[];

declare type browser$experiments$APIPath = string[];

declare type browser$experiments$APIEvents = browser$experiments$APIEvent[];
...
declare type browser$extensionTypes$PlainJSONValue =
  ...
  | number
  | boolean
  | browser$extensionTypes$_PlainJSONArray
  | browser$extensionTypes$_PlainJSONObject;

declare type browser$extensionTypes$_PlainJSONArray = { ... };
...
declare var npm$namespace$browser$geckoProfiler: {|
  ...
  dumpProfileToFile: typeof browser$geckoProfiler$dumpProfileToFile,
  ...
  getProfileAsGzippedArrayBuffer: typeof browser$geckoProfiler$getProfileAsGzippedArrayBuffer,
 ...
 */
declare function browser$geckoProfiler$dumpProfileToFile(
  fileName: string,
): Promise<any>;
 ...
 */
declare function browser$geckoProfiler$getProfileAsGzippedArrayBuffer(): Promise<any>;
...
declare function browser$identity$getAuthToken(details?: {
  ...
  scopes?: string[],
  ...
}): Promise<browser$identity$AccountInfo[]>;
...
declare function browser$management$get(
  id: browser$_manifest$ExtensionID,
): Promise<browser$management$ExtensionInfo>;
 ...
 */
declare function browser$management$getSelf(): Promise<browser$management$ExtensionInfo>;
...
declare var npm$namespace$browser$networkStatus: {|
  getLinkInfo: typeof browser$networkStatus$getLinkInfo,
  onConnectionChanged: typeof browser$networkStatus$onConnectionChanged,
|};
declare interface browser$networkStatus$NetworkLinkInfo {
  /**
   * Status of the network link, if "unknown" then link is usually assumed to be "up"
   */
  status: browser$networkStatus$_NetworkLinkInfoStatus;

  /**
   * If known, the type of network connection that is avialable.
   */
  type: browser$networkStatus$_NetworkLinkInfoType;
 ...
 * Status of the network link, if "unknown" then link is usually assumed to be "up"
 */
declare type browser$networkStatus$_NetworkLinkInfoStatus =
  | "unknown"
  | "up"
  | "down";
 ...
 * If known, the type of network connection that is avialable.
 */
declare type browser$networkStatus$_NetworkLinkInfoType =
  | "unknown"
  | "ethernet"
  | "usb"
  | "wifi"
 ...
 */
declare function browser$networkStatus$getLinkInfo(): Promise<browser$networkStatus$NetworkLinkInfo>;

/**
 * Fired when the network connection state changes.
 */
declare var browser$networkStatus$onConnectionChanged: WebExtEvent<
  (details: browser$networkStatus$NetworkLinkInfo) => void,
>;
 ...
 */
declare function browser$notifications$getAll(): Promise<{
  [key: string]: browser$notifications$CreateNotificationOptions,
  ...
}>;
...
declare interface browser$privacy$websites$CookieConfig {
   ...
   */
  behavior?: browser$privacy$websites$_CookieConfigBehavior;
...
declare interface browser$proxy$ProxyConfig {
   ...
   */
  proxyType?: browser$proxy$_ProxyConfigProxyType;
...
declare interface browser$proxy$_ProxyOnRequestEvent<
  TCallback = (details: {
    /**
 ...
 */
declare var browser$proxy$onError: WebExtEvent<(error: Error) => void>;
 ...
 */
declare var browser$proxy$onProxyError: WebExtEvent<(error: Error) => void>;
...
declare interface browser$runtime$Port {
  ...
  sender?: browser$runtime$MessageSender;
  error?: Error;
  onMessage: WebExtEvent<(response: { [key: string]: any }) => void>;
  onDisconnect: WebExtEvent<(port: browser$runtime$Port) => void>;
}
...
declare interface browser$runtime$PlatformInfo {
   ...
   * @deprecated Unsupported on Firefox at this time.
   */
  nacl_arch?: browser$runtime$PlatformNaclArch;
}
...
declare function browser$telemetry$registerScalars(
  category: string,
  data: {
    [key: string]: browser$telemetry$ScalarData,
    ...
  },
): Promise<any>;
...
declare function browser$telemetry$registerEvents(
  category: string,
  data: {
    [key: string]: browser$telemetry$EventData,
    ...
  },
): Promise<any>;
...
declare interface browser$webNavigation$_WebNavigationOnBeforeNavigateEvent<
  TCallback = (details: {
    /**
...
> {
  addListener(
    cb: TCallback,
    filters?: browser$webNavigation$EventUrlFilters,
  ): void;
  removeListener(cb: TCallback): void;
  hasListener(cb: TCallback): boolean;
}

declare interface browser$webNavigation$_WebNavigationOnCommittedEvent<
  TCallback = (details: {
    /**
...
declare interface browser$webNavigation$_WebNavigationOnDOMContentLoadedEvent<
  TCallback = (details: {
    /**
     * The ID of the tab in which the navigation occurs.
     */
...
declare interface browser$webNavigation$_WebNavigationOnCompletedEvent<
  TCallback = (details: {
    /**
     * The ID of the tab in which the navigation occurs.
     */
...
declare interface browser$webNavigation$_WebNavigationOnErrorOccurredEvent<
  TCallback = (details: {
    /**
     * The ID of the tab in which the navigation occurs.
     */
...
declare interface browser$webNavigation$_WebNavigationOnCreatedNavigationTargetEvent<
  TCallback = (details: {
    /**
...
declare interface browser$webNavigation$_WebNavigationOnReferenceFragmentUpdatedEvent<
  TCallback = (details: {
    /**
     * The ID of the tab in which the navigation occurs.
     */
...
declare interface browser$webNavigation$_WebNavigationOnHistoryStateUpdatedEvent<
  TCallback = (details: {
    /**
     * The ID of the tab in which the navigation occurs.
     */
...
declare interface browser$webRequest$SecurityInfo {
  state: browser$webRequest$_SecurityInfoState;
   ...
   */
  protocolVersion?: browser$webRequest$_SecurityInfoProtocolVersion;
 ...
 */
declare type browser$webRequest$UrlClassificationFlags =
  | "fingerprinting"
 ...
 */
declare type browser$webRequest$UrlClassificationParty = browser$webRequest$UrlClassificationFlags[];

declare interface browser$webRequest$UrlClassification {
  /**
   * First party classification flags if the request has been classified.
   */
  firstParty: browser$webRequest$UrlClassificationParty;

  /**
   * Third party classification flags if the request has been classified.
   */
  thirdParty: browser$webRequest$UrlClassificationParty;
}
...
declare interface browser$webRequest$_WebRequestOnBeforeRequestEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnBeforeSendHeadersEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnSendHeadersEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnHeadersReceivedEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnAuthRequiredEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnResponseStartedEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnBeforeRedirectEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnCompletedEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
declare interface browser$webRequest$_WebRequestOnErrorOccurredEvent<
  TCallback = (details: {
    /**
     * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
     * relate different events of the same request.
...
> {
  addListener(cb: TCallback, filter: browser$webRequest$RequestFilter): void;
  removeListener(cb: TCallback): void;
  hasListener(cb: TCallback): boolean;
}
 ...
 */
declare function browser$commands$getAll(): Promise<browser$commands$Command[]>;

/**
 * Fired when a registered command is activated using a keyboard shortcut.
 */
declare var browser$commands$onCommand: WebExtEvent<(command: string) => void>;
 ...
 */
declare function browser$devtools$network$getHAR(): Promise<{
  [key: string]: any,
  ...
}>;
...
declare interface browser$devtools$panels$ElementsPanel {
  ...
  createSidebarPane(
    title: string,
  ): Promise<browser$devtools$panels$ExtensionSidebarPane>;
...
): Promise<browser$devtools$panels$ExtensionPanel>;
 ...
 * @deprecated Unsupported on Firefox at this time.
 */
declare function browser$devtools$panels$setOpenResourceHandler(): Promise<browser$devtools$inspectedWindow$Resource>;
 ...
 */
declare type browser$contextMenus$_OverrideContextContext = "bookmark" | "tab";
...
declare interface browser$menus$OnClickData {
   ...
   * An array of keyboard modifiers that were held while the menu item was clicked.
   */
  modifiers: browser$menus$_OnClickDataModifiers[];
...
declare var npm$namespace$browser$normandyAddonStudy: {|
  getStudy: typeof browser$normandyAddonStudy$getStudy,
  endStudy: typeof browser$normandyAddonStudy$endStudy,
  getClientMetadata: typeof browser$normandyAddonStudy$getClientMetadata,
  onUnenroll: typeof browser$normandyAddonStudy$onUnenroll,
|};
declare interface browser$normandyAddonStudy$Study {
  /**
 ...
 */
declare function browser$normandyAddonStudy$getStudy(): Promise<any>;

/**
 * Marks the study as ended and then uninstalls the addon.
 * @param reason The reason why the study is ending.
 */
declare function browser$normandyAddonStudy$endStudy(
  reason: string,
): Promise<any>;
 ...
 */
declare function browser$normandyAddonStudy$getClientMetadata(): Promise<any>;

/**
 * Fired when a user unenrolls from a study but before the addon is uninstalled.
 * @param reason The reason why the study is ending.
 */
declare var browser$normandyAddonStudy$onUnenroll: WebExtEvent<
  (reason: string) => void,
>;
...
declare interface browser$tabs$_TabsOnUpdatedEvent<
  TCallback = (
    tabId: number,
    changeInfo: {
      /**
...
> {
  addListener(cb: TCallback, filter?: browser$tabs$UpdateFilter): void;
  removeListener(cb: TCallback): void;
  hasListener(cb: TCallback): boolean;
}
...
): Promise<browser$tabs$Tab | browser$tabs$Tab[]>;
 ...
 */
declare function browser$tabs$remove(tabIds: number | number[]): Promise<void>;

/**
 * discards one or more tabs.
 * @param tabIds The tab or list of tabs to discard.
 */
declare function browser$tabs$discard(tabIds: number | number[]): Promise<void>;
...
declare interface browser$topSites$MostVisitedURL {
   ...
   */
  type?: browser$topSites$_MostVisitedURLType;
}

/**
 * The entry type, either `url` for a normal page link, or `search` for a search shortcut.
 */
declare type browser$topSites$_MostVisitedURLType = "url" | "search";
...
declare var npm$namespace$browser$urlbar: {|
  openViewOnFocus: typeof browser$urlbar$openViewOnFocus,
  engagementTelemetry: typeof browser$urlbar$engagementTelemetry,
  onBehaviorRequested: typeof browser$urlbar$onBehaviorRequested,
  onQueryCanceled: typeof browser$urlbar$onQueryCanceled,
  onResultsRequested: typeof browser$urlbar$onResultsRequested,

  contextualTip: typeof npm$namespace$browser$urlbar$contextualTip,
|};

/**
 * A query performed in the urlbar.
 */
declare interface browser$urlbar$Query {
  /**
...
declare interface browser$urlbar$Result {
   ...
   * The result's source.
   */
  source: browser$urlbar$SourceType;

  /**
   * The result's type.
   */
  type: browser$urlbar$ResultType;
}
 ...
 */
declare type browser$urlbar$ResultType =
  | "remote_tab"
  | "search"
  | "tab"
  | "url";
 ...
 */
declare type browser$urlbar$SourceType =
  | "bookmarks"
  | "history"
  | "search"
  | "tabs"
...
declare interface browser$urlbar$_UrlbarOnBehaviorRequestedEvent<
  TCallback = (
    query: browser$urlbar$Query,
...
declare interface browser$urlbar$_UrlbarOnQueryCanceledEvent<
  TCallback = (query: browser$urlbar$Query) => void,
> {
  addListener(cb: TCallback, providerName: string): void;
  removeListener(cb: TCallback): void;
  hasListener(cb: TCallback): boolean;
...
declare interface browser$urlbar$_UrlbarOnResultsRequestedEvent<
  TCallback = (query: browser$urlbar$Query) => browser$urlbar$Result[],
> {
  addListener(cb: TCallback, providerName: string): void;
  removeListener(cb: TCallback): void;
  hasListener(cb: TCallback): boolean;
 ...
 */
declare var browser$urlbar$openViewOnFocus: browser$types$Setting;

/**
 * Enables or disables the engagement telemetry.
 */
declare var browser$urlbar$engagementTelemetry: browser$types$Setting;
 ...
 */
declare var browser$urlbar$onBehaviorRequested: browser$urlbar$_UrlbarOnBehaviorRequestedEvent<>;
 ...
 */
declare var browser$urlbar$onQueryCanceled: browser$urlbar$_UrlbarOnQueryCanceledEvent<>;
 ...
 */
declare var browser$urlbar$onResultsRequested: browser$urlbar$_UrlbarOnResultsRequestedEvent<>;

declare var npm$namespace$browser$urlbar$contextualTip: {|
  set: typeof browser$urlbar$contextualTip$set,
  remove: typeof browser$urlbar$contextualTip$remove,
  onButtonClicked: typeof browser$urlbar$contextualTip$onButtonClicked,
  onLinkClicked: typeof browser$urlbar$contextualTip$onLinkClicked,
|};

/**
 * An object containing the path to an icon, the title, button title, and link title to set on the contextual tip.
 */
declare interface browser$urlbar$contextualTip$ContextualTip {
  /**
 ...
 */
declare function browser$urlbar$contextualTip$set(
  details: browser$urlbar$contextualTip$ContextualTip,
): void;

/**
 * Hides the contextual tip (it will still be in the DOM).
 */
declare function browser$urlbar$contextualTip$remove(): void;
 ...
 */
declare var browser$urlbar$contextualTip$onButtonClicked: WebExtEvent<
 ...
 */
declare var browser$urlbar$contextualTip$onLinkClicked: WebExtEvent<
  (windowId: number) => void,
>;
 ...
 */
declare var browser$windows$onRemoved: WebExtEvent<(windowId: number) => void>;
...
declare type browser = {
  activityLog: typeof npm$namespace$browser$activityLog,
  alarms: typeof npm$namespace$browser$alarms,
  browserSettings: typeof npm$namespace$browser$browserSettings,
  captivePortal: typeof npm$namespace$browser$captivePortal,
  ...
  networkStatus: typeof npm$namespace$browser$networkStatus,
  ...
  normandyAddonStudy: typeof npm$namespace$browser$normandyAddonStudy,
  ...
  urlbar: typeof npm$namespace$browser$urlbar,
